Hi, this project is done with minilibx-linux, you have to compile it with the makefile, remember that you also have to give the program via keyboard the input "Mandelbrot" or "Julia n¹ n²" 
